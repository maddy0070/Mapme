...
Three modules, and each one earns its boundary:
...
core/location    Sampling strategy, foreground service, GPS cleaning.
core/map         Map engine wrapper, styled with the design system's map tokens.
...
- Kotlin `2.0.21`, AGP `8.7.3`, Gradle wrapper `8.14.3`, JDK 17.
